...
作成日 2025/06/16、更新日 2025/12/23

## 1. uvとは？

An extremely fast Python package and project manager, written in Rust.

Rustで書かれた、めちゃくちゃ速い、Pythonパッケージ＆プロジェクトマネージャ

公式ドキュメント => [uv](https://docs.astral.sh/uv/)

解説記事 => [uv （pythonパッケージマネージャー）の使い方　簡易版](https://qiita.com/futakuchi0117/items/9ec8bd84797fed180647)
