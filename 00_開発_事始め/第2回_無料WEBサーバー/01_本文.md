...
- `npm create cloudflare@latest`コマンドを実行する

|  No   | 質問                                 | 回答                |
| :---: | ------------------------------------ | ------------------- |
|   1   | install create-cloudlare package OK? | y                   |
|   2   | In which directory?                  | ./simple-web        |
|   3   | Which start with?                    | Hello World example |
|   4   | Which template?                      | Static site         |
|   5   | use git?                             | No                  |
|   6   | deploy your app?                     | No                  |
...
`public/index.html`を好きに編集して、自分らしいものにする
...
- サーバー名のパターン：`https://simple-web.{your-subdomain-name}.workers.dev/`
