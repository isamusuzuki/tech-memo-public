...
if __name__ == "__main__":
    body = products1('Python データ分析')
        with open('../temp/products1.xml',
...
## 02. 商品API - GetLowestPricedOffersForASIN

!!!注意!!! パラメーターはPOSTボディに入れる
